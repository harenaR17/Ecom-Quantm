  ...
  return (
    <div className="pt-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose prose-emerald max-w-none space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h2 className="text-2xl font-bold text-emerald-900 mb-4">Changes to This Privacy Policy</h2>
          <p className="text-gray-600">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h2 className="text-2xl font-bold text-emerald-900 mb-4">How We Collect and Use Your Personal Information</h2>
          <p className="text-gray-600">
          ...
          <h3 className="text-xl font-semibold text-emerald-800 mt-6 mb-3">What Personal Information We Collect</h3>
          <p className="text-gray-600">
            The types of personal information we obtain about you depends on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you. The following sections describe the categories and specific types of personal information we collect.
          </p>

          <h3 className="text-xl font-semibold text-emerald-800 mt-6 mb-3">Information We Collect Directly from You</h3>
          <p className="text-gray-600 mb-2">Information that you directly submit to us through our Services may include:</p>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <p className="text-gray-600">
            Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see <a href="https://www.shopify.com/legal/cookies" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-700">https://www.shopify.com/legal/cookies</a>. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services).
          </p>
        </div>

        <div className="bg-white rounded-lg shadow-sm p-8">
          <h2 className="text-2xl font-bold text-emerald-900 mb-4">How We Disclose Personal Information</h2>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h2 className="text-2xl font-bold text-emerald-900 mb-4">Children's Data</h2>
          <p className="text-gray-600">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h2 className="text-2xl font-bold text-emerald-900 mb-4">Your Rights</h2>
          <p className="text-gray-600 mb-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h2 className="text-2xl font-bold text-emerald-900 mb-4">Contact</h2>
          <p className="text-gray-600">
            Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:quantmcortx@gmail.com" className="text-emerald-600 hover:text-emerald-700">quantmcortx@gmail.com</a> or contact us at 12 Rue de l'Hippodrome, Nantes, 44300, FR.
          </p>
        </div>
      </div>
    </div>
