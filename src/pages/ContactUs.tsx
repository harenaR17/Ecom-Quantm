...
const ContactUs: React.FC = () => {
  return (
    <div className="pt-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-4xl font-bold text-red-900 mb-12 text-center">Contact Us</h1>
      ...
      <div className="space-y-8">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col items-center text-center p-6 bg-red-50 rounded-lg">
              <MessageCircle size={32} className="text-red-600 mb-4" />
              <h2 className="text-xl font-semibold text-red-900 mb-2">Live Chat</h2>
            ...
            <div className="flex flex-col items-center text-center p-6 bg-red-50 rounded-lg">
              ...
              <h2 className="text-xl font-semibold text-red-900 mb-2">Email Us</h2>
              <p className="text-gray-600">
                Send us an email at{' '}
                <a 
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="flex items-start space-x-4">
            <Clock size={24} className="text-red-600 flex-shrink-0 mt-1" />
            <div>
              <h2 className="text-xl font-semibold text-red-900 mb-2">Response Time</h2>
              <p className="text-gray-600">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h2 className="text-xl font-semibold text-red-900 mb-4">How Can We Help?</h2>
