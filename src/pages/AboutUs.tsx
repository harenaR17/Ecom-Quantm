  ...
  return (
    <div className="pt-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-emerald-900 mb-6">About Us</h1>
        <Heart className="mx-auto text-emerald-500 mb-8" size={40} />
      </div>
      ...
      <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          <div className="bg-emerald-50 rounded-lg p-6 text-center">
            <h3 className="text-emerald-900 font-semibold mb-2">Quality Products</h3>
            <p className="text-gray-600">Carefully selected wellness solutions that meet our high standards</p>
          </div>
          
          <div className="bg-emerald-50 rounded-lg p-6 text-center">
            <h3 className="text-emerald-900 font-semibold mb-2">Affordable Wellness</h3>
            <p className="text-gray-600">Making self-care accessible without compromising on quality</p>
          </div>
          
          <div className="bg-emerald-50 rounded-lg p-6 text-center">
            <h3 className="text-emerald-900 font-semibold mb-2">Customer Support</h3>
