...
const FAQs: React.FC = () => {
  return (
    <div className="pt-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-4xl font-bold text-emerald-900 mb-12 text-center">FAQs</h1>
        ...
        <div className="faq-section space-y-6">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">How can I contact Quant'M CortX?</h3>
              <div className="text-gray-600 space-y-2">
                ...
                <p>You can also email us at <a href="mailto:info@quantmcortx.com" className="text-emerald-600 hover:text-emerald-700">info@quantmcortx.com</a>, and our customer service team will be happy to assist you with any inquiries you may have.</p>
              </div>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">Do you ship worldwide?</h3>
              <p className="text-gray-600">Yes</p>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">Where do you ship from?</h3>
              <p className="text-gray-600">We ship from Hong Kong.</p>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">Can I change or cancel my order?</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">What payment methods do you accept?</h3>
              <p className="text-gray-600">We accept all major credit cards (VISA, Mastercard, AMEX) and PayPal payments.</p>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">When will my order be processed?</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">How long will it take to receive my order?</h3>
              <p className="text-gray-600">Due to high demand, orders may take between 2-4 weeks to arrive.</p>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">What if I don't receive my order?</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">Will I be charged with customs and taxes?</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">How do I return an item?</h3>
              <p className="text-gray-600">Please contact us via the live chat.</p>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">What if the item(s) I received are defective/incorrect/damaged?</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-emerald-800 mb-3">When will I receive my refund?</h3>
